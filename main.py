...
# Database Simulation with a dict
items = {
...
# We can simply use built-int python and Pydantic types, int this case dict[int, Item]
@app.get("/")
...
# here we can querty items like this /items?count=20
Selection = dict[
